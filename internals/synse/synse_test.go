...
func writeImg(arr *mat.CDense, outFileName string) error {
	realArr := realify(arr)
	img := toGrayImage(realArr)
...
func TestGetGrad(t *testing.T) {
	...
	err := writeImg(grad, "TestGetGrad.png")
	if err != nil {
		t.Fatal(err)
	}
}
...
func TestGetConvolver(t *testing.T) {
	...
	l2 := 1.0
	s := 0.0
	grad := getConvolver(M, N, a1, a2, l1, l2, s)
	if grad == nil {
		t.Fatal("getConvolver failed")
	}
	err := writeImg(grad, "TestGetConvolver.png")
	if err != nil {
		t.Fatal(err)
	}
}
...
func TestGetPsfFreq(t *testing.T) {
	...
	l2 := 1.0
	s := 0.0
	grad := GetPsfFreq(M, N, a1, a2, l1, l2, s)
	if grad == nil {
		t.Fatal("GetPsfFreq failed")
	}
	err := writeImg(grad, "TestGetPsfFreq.png")
	if err != nil {
		t.Fatal(err)
	}
}
...
func TestDoConvolve(t *testing.T) {
	...
	l2 := 1.0
	s := 0.0
	grad := DoConvolve(mat, a1, a2, l1, l2, s)
	if grad == nil {
		t.Fatal("")
	}
	err = writeImg(grad, "TestDoConvolve.png")
	if err != nil {
		t.Fatal(err)
	}
}
